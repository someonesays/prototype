...
export const MinigameValidation = {
  ...
  [MinigameOpcodes.SAVE_LOCAL_DATA]: z.object({
    data: z.union([z.string(), z.instanceof(Uint8Array), z.null(), z.undefined()]),
  }),
  ...
  [MinigameOpcodes.SEND_BINARY_GAME_MESSAGE]: z.object({ message: z.instanceof(Uint8Array) }),
  [MinigameOpcodes.SEND_BINARY_PLAYER_MESSAGE]: z.object({ message: z.instanceof(Uint8Array) }),
